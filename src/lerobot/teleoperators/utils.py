...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> Teleoperator:
    ...
    elif config.type == "piper_leader_end_effector":
        from .piper_leader.piper_leader_end_effector import PiperLeaderEndEffector

        return PiperLeaderEndEffector(config)
    else:
