...
@dataclass
class PiperFollowerConfig(PiperConfig):
    """
    Configuration for Piper follower robot.
    """
...
@dataclass
class PiperFollowerEndEffectorConfig(PiperFollowerConfig, BaseRobotEndEffectorConfig):
    """
    Configuration for Piper follower robot with end effector.
    """
